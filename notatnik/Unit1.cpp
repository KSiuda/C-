...
try {
 ...
 nazwapliku = SaveDialog1->FileName;
    ...
    { ShowMessage("Zapis niemo¿liwy. Spróbuj ponownie póŸniej.");
    }
}
...
void __fastcall TForm1::Nowy1Click(TObject *Sender)
{
   ...
   "Czy na pewno otworzyæ nowy plik?","PotwierdŸ",
...
void __fastcall TForm1::ZapraszamnaBlog1Click(TObject *Sender)
{
