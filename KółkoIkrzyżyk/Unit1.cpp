...
//p1-p9 pola w grze    p1='n' lub p1='x' lub p1='o'
char kto;
...
void  sprawdz()
{
 if ((p1==p2 && p2==p3 && p1!='n') ||
   ...
   {
     char * w;
     if (kto=='x') w="Wygrywa Agata!";
     else w="Wygrywa Konrad!";
   ...
   Application->MessageBox("CHUJ DUPA CYCKI REMIS, ZACZNIJ OD NOWA", MB_OK);
